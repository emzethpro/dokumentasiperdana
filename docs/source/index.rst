...
Legal Notice
-----------
This API documentation is provided for informational purposes. Usage of the `RTA Dubai Bus Timing <https://dubaitime.github.io/>`_ and Journey Planner API is subject to RTA's terms of service and data usage policies.
